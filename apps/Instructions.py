...
def app():
	...
	- Have one column for each phase you would like to track progress
	- Each phase column should have only dates or blanks (for when an item has not yet reached that phase)
	...
	- Columns after phases can be included if you would like to do grouping in Flow Metric calculations	
	""")
